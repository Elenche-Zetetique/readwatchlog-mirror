...
```
cd existing_repo
git remote add origin https://gitlab.com/logismiko/readwatchlog.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/logismiko/readwatchlog/-/settings/integrations)
